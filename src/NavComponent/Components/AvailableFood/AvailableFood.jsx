...
const AvailableFood = ({availableFood}) => {
    const {name,image,displayName,photoURL,quantity,location,expireDate,note}=availableFood
    return (
        <div>
  ...
  <div className="card-body flex-1">
    ...
    <button className="w-full btn btn-outline text-orange-400">VIEW DETAIL</button>
  </div>
</div>
        </div>
    );
